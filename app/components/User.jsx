...
export default (props) => {
  let user = props.user;
  let updateProfile = props.updateProfile;
  if (user === "") {
    ...
    <div className="container">
      <div className="col-xs-12 col-sm-4">
        ...
        <form onSubmit={evt => {
          evt.preventDefault()
          updateProfile(user.id, evt.target.name.value)
        } }>
            ...
            <fieldset className="form-group">
              ...
              <div className="form-check">
                <label className="form-check-label">
                  ...
                  <span className="radio-btn-description">Make {user.name} an Administrator</span>
                </label>
              </div>
              <div className="form-check disabled">
                <label className="form-check-label">
                  ...
                  <span className="radio-btn-description">Revoke {user.name}'s Administrator rights</span>
                </label>
              </div>
            </fieldset> ) : '' }
